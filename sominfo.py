...
bot_token = "5781335152:AAE7vn-6f0Sre4vN9vDgzLjiv-22aA82EPI"

bot = Client("namebots", api_id=api_id, api_hash=api_hash, bot_token=bot_token)
...
def main(number):
    global name, saa
    la1 = "".join(
        random.choice(string.digits + string.ascii_letters.upper()) for i in range(8)
    )
    la2 = "".join(
        random.choice(string.digits + string.ascii_letters.upper()) for i in range(4)
    )
    la3 = "".join(
        random.choice(string.digits + string.ascii_letters.upper()) for i in range(4)
    )
    ...
    la5 = "".join(
        random.choice(string.digits + string.ascii_letters.upper()) for i in range(12)
    )
    la0 = "-"
    ...
    heads = {
        "Host": "proxy.waafi.com",
        "Accept": "*/*",
        "Content-Type": "application/json",
        "Accept-Encoding": "gzip, deflate",
        "If-None-Match": 'W/"f64d-H4W52spMA+Fje37WNXpH2qRSGjc"',
        "User-Agent": "WAAFI/7.0.1 (iPhone; iOS 15.5; Scale/3.00)",
        "Accept-Language": "en-US;q=1, ar-US;q=0.9",
        "Content-Length": "960",
    }
    headas = {
        "Host": "serverb.waafi.com",
        "Accept": "*/*",
        "Content-Type": "application/json",
        "Accept-Encoding": "gzip, deflate",
        "If-None-Match": 'W/"f64d-H4W52spMA+Fje37WNXpH2qRSGjc"',
    ...
    data = {
        "token": {
            ...
            "serviceInfo": {
                "requestAttributes": {
                    "deviceIdType": " ",
                    "userPassword": "maalaa09",
                    "subscriptionId": "16465780322",
                    "userType": "CUSTOMER",
                    "authMode": "password",
                    "deviceId": "{}".format(lca),
            ...
            "requestId": "{}".format(sa),
            "timestamp": "1659971102777.958984",
            "systemInfo": {"systemId": "null", "systemSecret": "null"},
        }
    }
    pay = {
        "payload": {
            "mcc": "637",
            "deviceId": "33D35C9D-9EAF-46F9-8184-E60067EDE69C",
            "subscriptionId": "252636321503",
            "appVersion": "7.2.1",
            "deviceOs": "iOS",
            "appPlatform": "iOS",
        }
        ...
        "token": {
            ...
            "serviceInfo": {
                "requestAttributes": {
                    ...
                    "receiverMobile": "{}".format(no),
                    "txAmount": "1",
                },
                "serviceName": "GetReceiverInfo",
                "serviceCode": "0000",
            },
            "requestId": "{}".format(la),
            "systemInfo": {"systemId": "null", "systemSecret": "null"},
                    ...
                    if tt.total_seconds() < float(tr):
                        ...
                        try:
                            ...
                            if number.isdigit():
                                main(number)
                                try:
                                    name = saa["serviceInfo"]["responseAttributes"][
                                        "ReceiverInfo"
                                    ]["NAME"]
                                ...
                                await message.reply_text(
                                    text="Please send me a number only"
                                )
                        except IndexError:
                            return final
        ...
        await message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "Individual - $0.99/month", callback_data="individual"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            "Group - $2.95/month", callback_data="group"
                        )
                    ],
                ]
            ),
    ...
    if CallbackQuery.data == "individual":
        ...
        while True:
            ...
            if mohh.text == "/start" or mohh.text == "/iibso" or "/no" in mohh.text:
                ...
                try:
                    ...
                    await bot.send_message(
                        CallbackQuery.message.chat.id,
                        "✘ Numberka aad galisay waa qalad",
                    )
                    continue
                except BadRequest:
                    await bot.send_message(
        ...
        while True:
            ...
            try:
                ...
                await bot.send_message(
                    CallbackQuery.message.chat.id,
                    "✘ Fadlan usernameka groupka qaab saxan usoo dir",
                )
                continue
